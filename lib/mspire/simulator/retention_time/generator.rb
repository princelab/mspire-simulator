      ...
      module Generator
        ...
        def generateRT(one_d, db, opts)
          ...
          peps.each do |pep|
            ...
            p_rt = init_p_rt * 10**-2
            percent_time = p_rt 
            sx = Mspire::Simulator::RetentionTime::Helper.gaussian(percent_time,0.5,0.45,1.0) * Math.sqrt(abu) #need to figure out what these values should be
